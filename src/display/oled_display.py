...
class OLEDDisplay:
    def __init__(self, sda_pin=21, scl_pin=22, width=128, height=64):
        ...
        # --- ICONE BITMAP CORRETTE (Conteggio Byte Verificato) ---
        
        # Icona WiFi Grande (24x24) - Richiede 72 Bytes
        ...
        # Icona CLOUD (32x24) - Richiede 96 Bytes
        ...
        # Icona ALERT GIGANTE (48x48) - Richiede 288 Bytes
        ...
        # LOGO DATA (Il tuo logo originale)
    ...
    def show_wifi_connecting(self):
        self.clear()
        # Icona WiFi Grande (24x24) centrata (128-24)/2 = 52
    ...
    def show_mqtt_connecting(self):
        self.clear()
        # Icona CLOUD (32x24) centrata (128-32)/2 = 48
    ...
    def show_main_screen(self, gate_status, parking_status, gas_level, 
                        alarm_active=False, distance=None, lux_level=None):
        self.clear()
